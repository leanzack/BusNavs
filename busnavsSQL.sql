...
-- Dumping data for table busnavs.driver: ~0 rows (approximately)
DELETE FROM `driver`;
INSERT INTO `driver` (`driver_id`, `driver_name`, `fare`, `route_name`) VALUES
	(111, 'Toril-Driver', NULL, NULL),
	(222, 'Sawmill-Driver', NULL, NULL),
...
-- Dumping data for table busnavs.passenger: ~0 rows (approximately)
...
-- Dumping data for table busnavs.routes: ~0 rows (approximately)
DELETE FROM `routes`;
...
-- Dumping data for table busnavs.selectedroutes: ~0 rows (approximately)
...
-- Dumping data for table busnavs.ticket: ~0 rows (approximately)
DELETE FROM `ticket`;
